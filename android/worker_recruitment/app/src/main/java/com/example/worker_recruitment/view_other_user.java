...
public class view_other_user extends AppCompatActivity implements TextWatcher, AdapterView.OnItemSelectedListener {
    ListView vou;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vou=(ListView) findViewById(R.id.vou);
        skill=(Spinner)findViewById(R.id.spinner2);
        skill_load();
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                for(int i=0;i<js.length();i++)
                                {
                                    ...
                                    lid[i]=u.getString("loginid");

//

                                }
                                vou.setAdapter(new Custom_view_other_user(getApplicationContext(),name,image,occupation,email,lid));
                            }
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                Toast.makeText(view_other_user.this, "data="+js, Toast.LENGTH_SHORT).show();
...
//                params.put("mac",maclis);
    ...
    public void afterTextChanged(final Editable s) {
        SharedPreferences sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        String hu = sh.getString("ip", "");
        String url = "http://" + hu + ":5000/and_view_other_user";
        RequestQueue requestQueue = Volley.newRequestQueue(getApplicationContext());
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    @Override
...
//                params.put("mac",maclis);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        SharedPreferences sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        String hu = sh.getString("ip", "");
        String url = "http://" + hu + ":5000/skill_base_search";
        RequestQueue requestQueue = Volley.newRequestQueue(getApplicationContext());
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    @Override
...
//
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("skills",skill.getSelectedItem().toString());
//                params.put("mac",maclis);
