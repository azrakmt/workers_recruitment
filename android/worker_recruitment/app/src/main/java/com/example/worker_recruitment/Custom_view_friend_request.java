...
public class Custom_view_friend_request extends BaseAdapter {
    ...
    public Custom_view_friend_request(Context applicationContext, String[] name, String[] image,String[]occupation,String[] email,String[]reqid) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
        {
            ...
            gridView=inflator.inflate(R.layout.custom_view_friend_request,null);
        ...
        TextView cn=(TextView)gridView.findViewById(R.id.textView2);
        ImageView ci=(ImageView) gridView.findViewById(R.id.imageView2);
        TextView ocptn=(TextView)gridView.findViewById(R.id.textView3);
        TextView ce=(TextView)gridView.findViewById(R.id.textView12);
        Button ca=(Button)gridView.findViewById(R.id.button);
        Button cr=(Button)gridView.findViewById(R.id.button2);
        ca.setTag(reqid[position]);
        ...
        cr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url = "http://" + hu + ":5000/reject";
        ...
        ca.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences sh= PreferenceManager.getDefaultSharedPreferences(context.getApplicationContext());
                String hu = sh.getString("ip", "");
                String url = "http://" + hu + ":5000/accept";
