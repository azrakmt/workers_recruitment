...
public class  view_friend_request extends AppCompatActivity {
    ListView vfr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vfr = (ListView) findViewById(R.id.vfr);
        SharedPreferences sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        String hu = sh.getString("ip", "");
        String url = "http://" + hu + ":5000/view_recieve_request";
...
//
                                ...
                                vfr.setAdapter(new Custom_view_friend_request(getApplicationContext(), name, image,occupation, email,reqid));
                            }
